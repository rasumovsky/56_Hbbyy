...
#ifdef DHToyTree_cxx
DHToyTree::DHToyTree(TTree *tree) : fChain(0) 
{
...
Int_t DHToyTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DHToyTree::LoadTree(Long64_t entry)
{
...
void DHToyTree::Init(TTree *tree)
{
...
void DHToyTree::Show(Long64_t entry)
{
...
Int_t DHToyTree::Cut(Long64_t entry)
{
